/// Physics simulation for gesture animations.
///
...
mod tests {
    ...
    fn spring_force_with_velocity() {
        let s = Spring::new(600.0, 0.8);
        // F = -600*2.0 - 0.8*100.0 = -1200 - 80 = -1280
    ...
    fn spring_convergence() {
        // Start displaced +100px with zero velocity; step many times at 60fps.
    ...
    fn spring_negative_displacement() {
        let s = Spring::new(600.0, 0.8);
        // Negative displacement should produce positive restoring force.
        let f = s.force(-1.0, 0.0);
